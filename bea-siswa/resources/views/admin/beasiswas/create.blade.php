...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.beasiswas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="nomer_telpon">{{ trans('cruds.beasiswa.fields.nomer_telpon') }}</label>
                <input class="form-control {{ $errors->has('nomer_telpon') ? 'is-invalid' : '' }}" type="text" name="nomer_telpon" id="nomer_telpon" value="{{ old('nomer_telpon', '') }}">
                @if($errors->has('nomer_telpon'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nomer_telpon') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.beasiswa.fields.name_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('umur') ? 'is-invalid' : '' }}" type="text" name="umur" id="umur" value="{{ old('umur', '') }}">
                @if($errors->has('umur'))
                    <div class="invalid-feedback">
                        {{ $errors->first('umur') }}
                    </div>
